...
export default function Sidebar() {
  ...
  return (
    ...
    <div className='sidebar' >
     ...
     <p><img  className="me-2" style={{width:"20px"}}src='https://img.icons8.com/?size=512&id=RHtRRB1E4DKI&format=png' alt='img'></img> <Link to={"/"}  className='tittles  text-decoration-none text-dark'>Sent</Link> </p> 
     </div>
</div> 
